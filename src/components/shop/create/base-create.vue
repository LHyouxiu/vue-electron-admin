<template>
  <el-form ref="form" label-width="80px">
    <el-form-item label="商品名称">
      <el-input :value="title" placeholder="请输入商品名称,不能超过60个字符"
      @input="vModel('title',$event)" class="width:50%"></el-input>
    </el-form-item>
    ...
    <el-form-item label="商品描述">
      <el-input type="textarea" :value="desc"
        ...
        placeholder="选填,商品卖点描述,例如:此款商品美观大方 性价比高 不容错过"
        class="w-50"></el-input>
    </el-form-item>
    ...
    <el-form-item label="总库存">
      <el-input type="number" :value="stock"
        @input="vModel('stock',$event)" placeholder="" class="w-25">
        <template slot="append">件</template>
      </el-input>
    </el-form-item>
    <el-form-item label="库存预警">
      <el-input type="number" :value="min_stock"
        @input="vModel('min_stock',$event)" placeholder="" class="w-25">
        <template slot="append">件</template>
      </el-input>
    </el-form-item>
