  ...
  <table class="table table-sm table-bordered">
    <thead>
      ...
      <tr>
        ...
        {{th.name}}</th>
        <!-- <th scope="col" class="text-center" 
        style="vertical-align:middle">尺寸</th>
        <th scope="col" class="text-center" 
        style="vertical-align:middle">尺寸</th> -->
      </tr>
    </thead>
    <tbody>
      <tr v-for="(item,index) in list" :key="index">
        ...
        <td class="text-center" width="100">
          <input type="number" v-model="item.stock" class="form-control text-center"></td>
        <td class="text-center" width="100">
          <input type="number" v-model="item.volume" class="form-control text-center"></td>
        <td class="text-center" width="100">
          <input type="number" v-model="item.weight" class="form-control text-center"></td>
        <td class="text-center" width="100">
          <input type="text" v-model="item.code" class="form-control text-center"></td>
      </tr>
    </tbody>
  </table>
</template>
