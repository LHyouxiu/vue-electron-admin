	...
	<div>
		...
		<el-container style="position: absolute;top: 55px;bottom: 0;left: 0;right: 0;">
		  ...
		  <el-footer class="border-top d-flex align-items-center px-0">
			  <!-- 底部 -->
				<div class="h-100 d-flex align-items-center justify-content-center border-right" 
...
<script>
	...
	export default {
		...
		computed: {
			albumModelTitle() {//提示框标题 albumEditIndex修改时为点击相册index
